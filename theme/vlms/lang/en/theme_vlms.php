...
$string['pluginname'] = 'vlms';
$string['configtitle'] = 'vlms';
$string['choosereadme'] = 'vlms is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['platform_access'] = 'Access to the vlms LMS platform';
...
$string['cachedef_fontawesomevlmsiconmapping'] = 'Theme icon font definition';
...
$string['privacy:metadata:preference:themevlmssettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themevlmssettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themevlmssettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themevlmssettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
