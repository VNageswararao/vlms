...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themevlmssettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themevlmssettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettinggsavedsuccessfully', 'theme_vlms'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themevlmssettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themevlmssettings_enableaccessibilitytoolbar', false)
        ];
    }
